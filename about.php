    ...
    <div class="container mt-5 ">
      <div class="row justify-content-around">
        <div class="col-md-5 mt-3">
          <h3 class="text-warning pt-3 title">Treasury Store</h3>
          <h4>Whoever said cash can't purchase joy basically didn't know where to go shopping.</h4>
          <hr />
          <img
        ...
        <div class="col-md-5 mt-3">
          ...
          <h3>If shopping doesn't make you glad, at that point you're in the wrong shop.</h3>
          <hr>
